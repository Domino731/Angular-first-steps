...
public class PlayerAnimations {
    ...
    public void running(SpriteBatch sb) {
        ...
        sb.draw(armsTextures[PlayerTextures.STATE_RUNNING_DOWN][0], finalPosition.x - 40, finalPosition.y, 16, 32);
        ...
        sb.draw(armsTextures[PlayerTextures.STATE_RUNNING_DOWN][1], finalPosition.x - 20, finalPosition.y, 16, 32);
        ...
        sb.draw(armsTextures[PlayerTextures.STATE_RUNNING_DOWN][2], finalPosition.x, finalPosition.y, 16, 32);
        ...
        sb.draw(armsTextures[PlayerTextures.STATE_RUNNING_DOWN][3], finalPosition.x + 20, finalPosition.y, 16, 32);
        sb.draw(player.style.hatsArray[PlayerConstants.hatTextureIndex], (finalPosition.x - 2) + 20, (finalPosition.y + 12) + 1, 20, 20);
        ...
        sb.draw(armsTextures[PlayerTextures.STATE_RUNNING_DOWN][4], finalPosition.x + 40, finalPosition.y, 16, 32);
        sb.draw(player.style.hatsArray[PlayerConstants.hatTextureIndex], (finalPosition.x - 2) + 40, (finalPosition.y + 12), 20, 20);
        ...
        sb.draw(armsTextures[PlayerTextures.STATE_RUNNING_DOWN][5], finalPosition.x + 60, finalPosition.y, 16, 32);
        ...
        sb.draw(armsTextures[PlayerTextures.STATE_RUNNING_DOWN][6], finalPosition.x + 80, finalPosition.y, 16, 32);
        ...
        sb.draw(armsTextures[PlayerTextures.STATE_RUNNING_DOWN][7], finalPosition.x + 100, finalPosition.y, 16, 32);
