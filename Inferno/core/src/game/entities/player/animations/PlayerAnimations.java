...
public class PlayerAnimations {
    ...
    public void running(SpriteBatch sb) {
        sb.draw(bodyTextures[PlayerTextures.STATE_RUNNING_ITEM_DOWN][0], finalPosition.x - 40, finalPosition.y, 16, 32);
        ...
        sb.draw(armsTextures[PlayerTextures.STATE_RUNNING_ITEM_DOWN][0], finalPosition.x - 40, finalPosition.y, 16, 32);
        sb.draw(player.style.hatsArray[PlayerConstants.hatTextureIndex], (finalPosition.x - 2) - 40, (finalPosition.y + 12), 20, 20);

        sb.draw(bodyTextures[PlayerTextures.STATE_RUNNING_ITEM_DOWN][1], finalPosition.x - 20, finalPosition.y, 16, 32);
        ...
        sb.draw(armsTextures[PlayerTextures.STATE_RUNNING_ITEM_DOWN][1], finalPosition.x - 20, finalPosition.y, 16, 32);
        sb.draw(player.style.hatsArray[PlayerConstants.hatTextureIndex], (finalPosition.x - 2) - 20, (finalPosition.y + 12) - 1, 20, 20);

        sb.draw(bodyTextures[PlayerTextures.STATE_RUNNING_ITEM_DOWN][2], finalPosition.x, finalPosition.y, 16, 32);
        ...
        sb.draw(armsTextures[PlayerTextures.STATE_RUNNING_ITEM_DOWN][2], finalPosition.x, finalPosition.y, 16, 32);
        sb.draw(player.style.hatsArray[PlayerConstants.hatTextureIndex], (finalPosition.x - 2), (finalPosition.y + 12), 20, 20);

        sb.draw(bodyTextures[PlayerTextures.STATE_RUNNING_ITEM_DOWN][3], finalPosition.x + 20, finalPosition.y, 16, 32);
        ...
        sb.draw(armsTextures[PlayerTextures.STATE_RUNNING_ITEM_DOWN][3], finalPosition.x + 20, finalPosition.y, 16, 32);
        sb.draw(player.style.hatsArray[PlayerConstants.hatTextureIndex], (finalPosition.x - 2) + 20, (finalPosition.y + 12) + 1, 20, 20);

        sb.draw(bodyTextures[PlayerTextures.STATE_RUNNING_ITEM_DOWN][4], finalPosition.x + 40, finalPosition.y, 16, 32);
        sb.draw(player.style.hairArray[2], finalPosition.x + 40, finalPosition.y - 4, PlayerHairsData.HAIR_SIZE.width, PlayerHairsData.HAIR_SIZE.height);
        ...
        sb.draw(armsTextures[PlayerTextures.STATE_RUNNING_ITEM_DOWN][4], finalPosition.x + 40, finalPosition.y, 16, 32);
        sb.draw(player.style.hatsArray[PlayerConstants.hatTextureIndex], (finalPosition.x - 2) + 40, (finalPosition.y + 12), 20, 20);

        sb.draw(bodyTextures[PlayerTextures.STATE_RUNNING_ITEM_DOWN][5], finalPosition.x + 60, finalPosition.y, 16, 32);
        ...
        sb.draw(armsTextures[PlayerTextures.STATE_RUNNING_ITEM_DOWN][5], finalPosition.x + 60, finalPosition.y, 16, 32);
        sb.draw(player.style.hatsArray[PlayerConstants.hatTextureIndex], (finalPosition.x - 2) + 60, (finalPosition.y + 12) - 1, 20, 20);

        sb.draw(bodyTextures[PlayerTextures.STATE_RUNNING_ITEM_DOWN][6], finalPosition.x + 80, finalPosition.y, 16, 32);
        ...
        sb.draw(armsTextures[PlayerTextures.STATE_RUNNING_ITEM_DOWN][6], finalPosition.x + 80, finalPosition.y, 16, 32);
        sb.draw(player.style.hatsArray[PlayerConstants.hatTextureIndex], (finalPosition.x - 2) + 80, (finalPosition.y + 12), 20, 20);

        sb.draw(bodyTextures[PlayerTextures.STATE_RUNNING_ITEM_DOWN][7], finalPosition.x + 100, finalPosition.y, 16, 32);
        ...
        sb.draw(armsTextures[PlayerTextures.STATE_RUNNING_ITEM_DOWN][7], finalPosition.x + 100, finalPosition.y, 16, 32);
