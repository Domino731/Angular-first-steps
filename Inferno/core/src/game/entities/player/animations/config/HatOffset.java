...
public class HatOffset {
    ...
    private static byte[][] createOffsets() {
        ...
        data[PlayerTextures.STATE_RUNNING_RIGHT] = new byte[]{0, -1, 0, 1, 0, -1, 0, 1};
        data[PlayerTextures.STATE_RUNNING_DOWN] = new byte[]{-2};
        data[PlayerTextures.STATE_RUNNING_LEFT] = new byte[]{0, -1, 0, 1, 0, -1, 0, 1};
        // RUNNING WITH ITEM
        data[PlayerTextures.STATE_RUNNING_ITEM_UP] = new byte[]{-2};
        data[PlayerTextures.STATE_RUNNING_ITEM_RIGHT] = new byte[]{0, -1, 0, 1, 0, -1, 0, 1};
        data[PlayerTextures.STATE_RUNNING_ITEM_DOWN] = new byte[]{-2};
        data[PlayerTextures.STATE_RUNNING_ITEM_LEFT] = new byte[]{0, -1, 0, 1, 0, -1, 0, 1};
