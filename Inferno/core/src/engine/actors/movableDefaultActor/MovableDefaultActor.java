...
//        sb.draw(playerTextures.bodyTextures[1][1], finalPosition.x, finalPosition.y, 16, 32);
//        sb.draw(playerTextures.armsTextures[1][1], finalPosition.x, finalPosition.y, 16, 32);
